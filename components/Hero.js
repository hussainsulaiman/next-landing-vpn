  ...
  return (
    <div className="max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto" id="home">
      ...
      <div className="relative  w-full flex">
        <ScrollAnimationWrapper className="rounded-lg bg-orange-500 align-self: center w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-4 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-100 bg-white-500 z-10">
